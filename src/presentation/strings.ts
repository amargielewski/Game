...
const TRANSLATIONS = {
  pl: {
    ...
    guideBad: 'Uwaga — złapane zabierają punkty:',
    guideBonus: 'Plaster miodu przelatuje w poprzek — wyskocz po niego.',
    guideMiss: 'Wszystko, co spadnie na ziemię, kosztuje życie — robaki też.',
  ...
  en: {
    ...
    guideBad: 'Careful — catching these costs points:',
    guideBonus: 'The honeycomb flies across — jump for it.',
    guideMiss: 'Anything that hits the ground costs a life, bugs included.',
